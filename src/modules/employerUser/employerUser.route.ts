...
import {uploadFields} from "../../multer/multer.uploadBannerAndLogo"
...
router.patch("/update-company-information",verifyTokenMiddleware, roleCheckMiddleware("employer"),uploadFields,updateCompanyInfo);
